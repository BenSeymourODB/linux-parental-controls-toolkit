 ...
 * Dashboard system-status strip (#321) to show at-a-glance service health.
 *
 * License boundary: none — JSON API only.
 */
import { apiFetch } from "./client.js";
import type { AdGuardManagedStatusResponse, AnsibleVenvStatusResponse } from "./contract.js";
